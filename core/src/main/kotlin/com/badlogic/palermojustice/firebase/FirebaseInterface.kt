...
interface FirebaseInterface {
    ...
    fun sendVote(targetPlayerId: String, round: Int, voteType: String, callback: (Boolean) -> Unit)
    fun countVotes(round: Int, voteType: String, callback: (Map<String, Int>) -> Unit)
    fun listenForVotes(round: Int, voteType: String, callback: (Map<String, String>) -> Unit)
